...
Загружаем данные с Яндекс Диска если они отсутствуют в локальном хранилище dvc
...
Для продвинутой модели выбрана tabtransformer<br> Архитектура продвинутой
модели:
